...
<html lang="en">
   ...
   <body data-spy="scroll" data-target=".navbar" data-offset="50">
      ...
      <div class="slider" id="home">
         <div id="rev_slider_1_1_wrapper" class="rev_slider_wrapper fullscreen-container" data-alias="slider-shop" data-source="gallery" style="background:rgba(255,255,255,0);padding:0px;">
            ...
            <div id="rev_slider_1_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.8.1">
               <ul>
                  <!-- SLIDE-1 -->
                  <li data-index="rs-2" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-thumb="{{asset('front-end/classic-business/img/slide-1.png')}}"  data-rotate="0"  data-saveperformance="off"  data-title="Slide 2" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                     <!-- MAIN IMAGE -->
                     <img src="{{asset('front-end/classic-business/img/slide-1.jpg')}}"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="off" class="rev-slidebg" data-no-retina>
                     ...
                     <div class="tp-caption   tp-resizeme"
                        ...
                        style="z-index: 5; white-space: nowrap; font-size: 24px; line-height: 22px; font-weight: 500; color:#18191d;">Serving Since 1930</div>
                     <!-- LAYER NR. 7 -->
                     <div class="tp-caption   tp-resizeme"
                        id="slide-2-layer-2"
                        ...
                        data-paddingbottom="[0,0,0,0]"
                        data-paddingleft="[0,0,0,0]"
                        style="z-index: 6; white-space: nowrap; font-size: 60px; line-height: 16px; font-weight: 600; color: #032a58; letter-spacing: 0px;">Classic Business</div>
                     <!-- LAYER NR. 8 -->
                     <div class="tp-caption   tp-resizeme"
                        id="slide-2-layer-3"
                        ...
                        data-paddingbottom="[0,0,0,0]"
                        data-paddingleft="[0,0,0,0]"
                        style="z-index: 7; white-space: normal; font-size: 18px; line-height: 22px; font-weight: 400; color: #18191d; letter-spacing: 0px; ">We are a new Digital Agency based in USA. We have over 10
                        years of experience about designing websitesand mobile apps.
                     </div>
                     <div class="tp-caption   tp-resizeme"
                        id="slide-2-layer-4"
                  ...
                  <!-- SLIDE-2 -->
                  <li data-index="rs-4" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-thumb="{{asset('front-end/classic-business/img/slide-2.jpg')}}"  data-rotate="0"  data-saveperformance="off"  data-title="Slide 4" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                     <!-- MAIN IMAGE -->
                     <img src="{{asset('front-end/classic-business/img/slide-2.jpg')}}"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="off" class="rev-slidebg" data-no-retina>
                     ...
                     <div class="tp-caption   tp-resizeme"
                        ...
                        data-paddingbottom="[0,0,0,0]"
                        data-paddingleft="[0,0,0,0]"
                        style="z-index: 6; white-space: nowrap; font-size: 60px; line-height: 16px; font-weight: 600; color: #032a58; letter-spacing: 0px;">Digital Agency</div>
                     <!-- LAYER NR. 17 -->
                     <div class="tp-caption   tp-resizeme"
                        id="slide-4-layer-3"
                        data-x="['left','center','center','center']" data-hoffset="['3','0','0','0']"
                  ...
                  <!-- SLIDE-3 -->
                  <li data-index="rs-1" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-thumb="{{asset('front-end/classic-business/img/slide-3.jpg')}}"  data-rotate="0"  data-saveperformance="off"  data-title="Slide 1" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                     <!-- MAIN IMAGE -->
                     <img src="{{asset('front-end/classic-business/img/slide-3.jpg')}}"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="off" class="rev-slidebg" data-no-retina>
                     <div class="bg-overlay bg-white opacity-2"></div>
                     <!-- LAYERS -->
                     <!-- LAYER NR. 1 -->
                     <div class="tp-caption   tp-resizeme"
                     ...
                     <div class="tp-caption   tp-resizeme"
                        ...
                        data-paddingbottom="[0,0,0,0]"
                        data-paddingleft="[0,0,0,0]"
                        style="z-index: 6; white-space: nowrap; font-size: 60px; line-height: 16px; font-weight: 600; color: #032a58; letter-spacing: 0px;">Digital Company</div>
                     <!-- LAYER NR. 3 -->
                     <div class="tp-caption   tp-resizeme"
                        id="slide-1-layer-3"
                        data-x="['left','center','center','center']" data-hoffset="['3','0','0','0']"
                        ...
                        data-paddingbottom="[0,0,0,0]"
                        data-paddingleft="[0,0,0,0]"
                        style="z-index: 7; white-space: normal; font-size: 18px; line-height: 22px; font-weight: 400; color: #18191d; letter-spacing: 0px; ">We are a USA based Digital Agency based. We have 10
                        years of experience about designing websitesand mobile apps.
                     </div>
                     <div class="tp-caption   tp-resizeme"
                        id="slide-1-layer-8"
      ...
      <div class="learn-more-section">
         <div class="container">
            <div class="text-area wow fadeInDown" data-wow-delay="300ms">
               ...
               <a class="btn button btn-rounded trans-btn btn-hvr-white wow fadeInUp" data-wow-delay="300ms" href="javascript:void(0);">
                  Learn
                  More
                  <div class="btn-hvr-setting">
                     <ul class="btn-hvr-setting-inner">
      ...
      <div class="counter-section">
         <div class="container">
            <h2 class="wow fadeInDown" data-wow-delay="300ms">Statistical Numbers</h2>
                  ...
                  <div class="counter">
                     <div class="media">
                        ...
                        <div class="media-body">
                           <span class="timer count-title count-number" data-to="548" data-speed="9000"></span>
               ...
               <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12 wow fadeInLeft" data-wow-delay="400ms">
                  <div class="counter">
                     <div class="media">
                        ...
                        <div class="media-body">
                           <span class="timer count-title count-number" data-to="1465" data-speed="9000">K</span>
                           <p>Working Hours</p>
                        </div>
                     </div>
                  </div>
               ...
               <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12 wow fadeInRight" data-wow-delay="400ms">
                  <div class="counter">
                     <div class="media">
                        ...
                        <div class="media-body">
                           <span class="timer count-title count-number" data-to="612" data-speed="9000">K</span>
               ...
               <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12 wow fadeInRight" data-wow-delay="400ms">
                  <div class="counter">
                     <div class="media">
                        ...
                        <div class="media-body">
                           <span class="timer count-title count-number" data-to="735" data-speed="9000">K</span>
                           <p>Happy Clients</p>
                        </div>
                     </div>
                  </div>
      ...
      <div class="team-section" id="team">
         <div class="container">
            ...
            <div class=" text-center team-section-carousel owl-carousel owl-themes active wow zoomIn" data-wow-delay="400ms">
               <div class=" item">
                  <img src="{{asset('front-end/classic-business/img/team-1.jpg')}}" alt="image">
               ...
               <div class=" item" >
                  <img src="{{asset('front-end/classic-business/img/team-2.jpg')}}" alt="image">
                  <div class="team-detail">
                     <h5>Andrew Cusik</h5>
                     <p>Marketing Lead</p>
                  </div>
               ...
               <div class=" item">
                  <img src="{{asset('front-end/classic-business/img/team-3.jpg')}} " alt="image">
                  <div class="team-detail">
                     <h5>Sarah Jenifer</h5>
                     <p>Strategist</p>
                  </div>
      ...
      <div class="story-section">
         <div class="container">
            <div class="text-area wow fadeInDown" data-wow-delay="300ms">
               ...
               <h2>Watch Our Success Story</h2>
               <a data-fancybox="" href="https://www.youtube.com/watch?v=7e90gBu4pas" class="btn button btn-rounded trans-btn btn-hvr-white wow fadeInUp" data-wow-delay="300ms" >
      ...
      <div class="cubeportfolio" id="work">
         <div class="container">
            ...
            <div id="js-grid-mosaic-flat" class="cbp cbp-l-grid-mosaic-flat">
               <div class="cbp-item web-design graphic seo">
                  <a href="{{asset('front-end/classic-business/img/work-1.jpg')}}" class="cbp-caption cbp-lightbox" data-title="Bolt UI<br>by Tiberiu Neamu">
                     <div class="cbp-caption-defaultWrap">
                        <img src="{{asset('front-end/classic-business/img/work-1.jpg')}}" alt="">
                     </div>
               ...
               <div class="cbp-item seo marketing">
                  <a href="{{asset('front-end/classic-business/img/work-2.jpg')}}" class="cbp-caption cbp-lightbox" data-title="World Clock<br>by Paul Flavius Nechita">
                     <div class="cbp-caption-defaultWrap">
                        <img src="{{asset('front-end/classic-business/img/work-2.jpg')}}" alt="">
                     </div>
                     <div class="cbp-caption-activeWrap">
                        <div class="cbp-l-caption-alignCenter">
                           <div class="cbp-l-caption-body">
               ...
               <div class="cbp-item seo marketing">
                  <a href="{{asset('front-end/classic-business/img/work-4.jpg')}}" class="cbp-caption cbp-lightbox" data-title="WhereTO App<br>by Tiberiu Neamu">
                     <div class="cbp-caption-defaultWrap">
                        <img src="{{asset('front-end/classic-business/img/work-4.jpg')}}" alt="">
                     </div>
                     <div class="cbp-caption-activeWrap">
                        <div class="cbp-l-caption-alignCenter">
                           <div class="cbp-l-caption-body">
               ...
               <div class="cbp-item graphic seo marketing">
                  <a href="{{asset('front-end/classic-business/img/work-3.jpg')}}" class="cbp-caption cbp-lightbox" data-title="Seemple* Music<br>by Tiberiu Neamu">
                     <div class="cbp-caption-defaultWrap">
                        <img src="{{asset('front-end/classic-business/img/work-3.jpg')}}" alt="">
                     </div>
                     <div class="cbp-caption-activeWrap">
                        <div class="cbp-l-caption-alignCenter">
                           <div class="cbp-l-caption-body">
               ...
               <div class="cbp-item web-design graphic">
                  <a href="{{asset('front-end/classic-business/img/work-5.jpg')}}" class="cbp-caption cbp-lightbox" data-title="iDevices<br>by Tiberiu Neamu">
                     <div class="cbp-caption-defaultWrap">
                        <img src="{{asset('front-end/classic-business/img/work-5.jpg')}}" alt="">
                     </div>
                     <div class="cbp-caption-activeWrap">
                        <div class="cbp-l-caption-alignCenter">
                           <div class="cbp-l-caption-body">
               ...
               <div class="cbp-item seo marketing graphic">
                  <a href="{{asset('front-end/classic-business/img/work-6.jpg')}}" class="cbp-caption cbp-lightbox" data-title="Remind~Me Widget<br>by Tiberiu Neamu">
                     <div class="cbp-caption-defaultWrap">
                        <img src="{{asset('front-end/classic-business/img/work-6.jpg')}}" alt="">
                     </div>
                     <div class="cbp-caption-activeWrap">
                        <div class="cbp-l-caption-alignCenter">
                           <div class="cbp-l-caption-body">
               ...
               <div class="cbp-item web-design ">
                  <a href="{{asset('front-end/classic-business/img/work-7.jpg')}}" class="cbp-caption cbp-lightbox" data-title="Workout Buddy<br>by Tiberiu Neamu">
                     <div class="cbp-caption-defaultWrap">
                        <img src="{{asset('front-end/classic-business/img/work-7.jpg')}}" alt="">
                     </div>
                     <div class="cbp-caption-activeWrap">
                        <div class="cbp-l-caption-alignCenter">
                           <div class="cbp-l-caption-body">
               ...
               <div class="cbp-item web-design graphic">
                  <a href="{{asset('front-end/classic-business/img/work-8.jpg')}}" class="cbp-caption cbp-lightbox" data-title="Digital Menu<br>by Cosmin Capitanu">
                     <div class="cbp-caption-defaultWrap">
                        <img src="{{asset('front-end/classic-business/img/work-8.jpg')}}" alt="">
                     </div>
                     <div class="cbp-caption-activeWrap">
                        <div class="cbp-l-caption-alignCenter">
                           <div class="cbp-l-caption-body">
         ...
         <div class="container">
            <div class="row no-gutters">
               ...
               <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 wow fadeInRightBig" data-wow-delay="300ms">
                  <img src="{{asset('front-end/classic-business/img/blog-1.jpg')}}" alt="image">
               </div>
               <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 right-text order-2 order-lg-1 wow fadeInLeftBig" data-wow-delay="300ms">
                  <img src="{{asset('front-end/classic-business/img/blog-2.jpg')}}" alt="image">
               </div>
            ...
            <div class="row">
               <div class="col-lg-8 col-md-12 col-sm-12 wow fadeInLeft" data-wow-delay="300ms">
                  ...
                  <form class="contact-form" id="contact-form-data">
                     <div class="row">
                        ...
                        <a href="JavaScript:void(0);" class="btn button btn-rounded btn-light-blue btn-hvr-light-blue contact_btn">
                           SEND
                           <div class="btn-hvr-setting">
                              <ul class="btn-hvr-setting-inner">
                                 <li class="btn-hvr-effect"></li>
               ...
               <div class="col-lg-4 col-md-12 col-sm-12 wow fadeInRight" data-wow-delay="300ms">
                  <p>Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu
                     feugiat nulla facilisis accumsan.
                  </p>
                  <div class="media">
